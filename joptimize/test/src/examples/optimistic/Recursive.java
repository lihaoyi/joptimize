...
class Recursive {
    ...
    @joptimize.Test(
            inputs = {1, 2, 3, 4},
            checkRemoved = "joptimize.examples.simplify.Recursive.recursivePureConstant0"
    )
    ...
    @joptimize.Test(
            inputs = {1, 2, 3, 4},
            checkRemoved = {
                    "joptimize.examples.simplify.Recursive.mutualRecursivePureConstant1",
                    "joptimize.examples.simplify.Recursive.mutualRecursivePureConstant2"
            }
    )
    ...
    @joptimize.Test(
            inputs = {1, 2, 3, 4},
            checkPresent = {
                    "joptimize.examples.simplify.Recursive.generalRecursiveHelper"
            }
    )
