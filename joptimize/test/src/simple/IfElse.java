...
public class IfElse {
    @test.Test(inputs = {10, 11, 10, 9})
    public static int basicIf(int a, int b) {
        if (a < b) return a;
        else return -a;
    }

    @test.Test(inputs = {0, 1, 2, 3, 4, 5})
    ...
    @test.Test(inputs = {2, 1, 13, 13, 9, 9, 11, 11, 1, 10})
